...
| # | Tema | Descripción |
|---|------|-------------|
| 1 | print() | Salida por pantalla |
| 2 | Comentarios | Documentación del código |
| 3 | Variables | Tipos básicos de datos |
| 4 | Operadores | Aritméticos, comparación, lógicos |
| 5 | Condicionales | if / elif / else |
| 6 | Bucles | for y while |
| 7 | Listas | Estructuras ordenadas |
| 8 | Diccionarios | Clave-valor |
| 9 | Strings | Manipulación de texto |
| 10 | Funciones | Reutilización de código |
| 11 | Errores | try / except / finally |
| 12 | Módulos | Librerías externas |
| 13 | Práctico | Ejemplo integrado |
...
> **A:** split() divide un string en lista; join() une una lista en string
...
> **A:** print() muestra; return devuelve un valor usable dentro del código
